/**
 * Payment instructions shown to students after they sign up, before an
 * admin has approved their access. Edit these to your real details.
 */
export const PAYMENT_INFO = {
  amount: 'Rs. 500 / month',   // e.g. "Rs. 500 / month" or "Rs. 1000 one-time"
